...
export default {
  ...
  components: {
    ...
    TableTextSegmented: () => import('@/components/completion/TableTextSegmented'),
    SegmentationTags: () => import('@/components/deploy/cards/SegmentationTags'),
    TableImage: () => import('@/components/completion/TableImage'),
  },
  data: () => ({
    ops: {
      scrollPanel: {
...
.btn-reload {
  ...
  border-radius: 4px;
  box-shadow: 0 1px 3px 0 rgba(0, 133, 255, 0.5);
