<template>
  <div class="params" :key="'key_update-' + updateKey">
    <scrollbar class="params__scroll">
              ...
              <div class="params__fields">
                <template v-for="(data, i) of fields">
                  <TAutoFieldCascade
                    ...
                    @change="parse"
                  />
                  <DButton class="params__fields--btn" @click="onStart" :key="'key' + i" :disabled="overlayStatus">Подготовить</DButton>
                </template>
              </div>
            </at-collapse-item>
          </at-collapse>
        ...
        <div class="params__items" v-if="paramsDownloaded.isParamsSettingsLoad">
          <div class="params-container pa-5">
            <div class="t-input">
              ...
              <DInputText v-model="deploy" class="t-input__input" type="text" id="deploy[deploy]" name="deploy[deploy]" />
            </div>
            <Autocomplete2
              :value="serverLabel"
              :list="list"
            ...
            <div class="password" v-if="use_sec">
              <div class="t-input">
                <DInputText :type="passwordShow ? 'text' : 'password'" placeholder="Введите пароль" v-model="sec" />
            ...
            <DButton class="params__fields--btn" :disabled="send_disabled" @click="sendDeployData" v-if="!paramsDownloaded.isSendParamsDeploy"
            >
              Загрузить
            </DButton>
...
import TAutoFieldCascade from './TAutoFieldCascade.vue';
...
export default {
  ...
  methods: {
    ...
    async onStart() {
      console.log('downloadSettings', this.parameters)
