...
import Tuple from '@/components/new/forms/Tuple.vue';
import Select from '@/components/new/forms/Select.vue';
import DCheckbox from '@/components/new/forms/Checkbox.vue';
