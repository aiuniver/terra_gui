<template>
  <at-modal v-model="dialog" width="400" showClose>
    ...
    <template slot="footer">
      <d-button @click.native="save" :disabled="!image" style="flex-basis: 50%;">Сохранить</d-button>
      <d-button color="secondary" direction="left" cancel @click.native="close" style="flex-basis: 50%;">Отменить</d-button>
    </template>
  </at-modal>
</template>
