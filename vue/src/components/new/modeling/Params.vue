...
import Shape from '@/components/new/forms/Shape.vue';
import DAutocomplete from '@/components/new/forms/DAutocomplete.vue';
import TSelect from '@/components/new/forms/TSelect.vue';
