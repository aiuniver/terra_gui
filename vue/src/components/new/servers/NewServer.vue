<template>
  <div class="new-server">
    ...
    <form class="new-server__form" @submit.prevent="addServer">
      ...
      <d-button class="new-server__btn" :disabled="!validForm || loading">Добавить</d-button>
    </form>
