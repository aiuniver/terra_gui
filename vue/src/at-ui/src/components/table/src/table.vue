  ...
  <div
    ...
    <div class="at-table__content" :style="contentStyle">
      ...
      <div class="at-table__header" v-if="height">
        <table>
          <colgroup>
            <col v-for="(column, index) in columnsData" :key="'indesdx_' + index" :width="setCellWidth(column, index)">
          </colgroup>
      ...
      <div class="at-table__body" :style="bodyStyle">
        <table>
          <colgroup>
            <col v-for="(column, index) in columnsData" :key="'ind_' + index" :width="setCellWidth(column, index)">
          </colgroup>
          ...
          <tbody class="at-table__tbody" v-if="sortData.length" ref="body">
            <template v-for="(item, index) in sortData">
              <tr :key="'indsdex_' + index">
                ...
                <td v-for="(column, index) in columns" class="at-table__cell" :key="'inodex_' + index">
