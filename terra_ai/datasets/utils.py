...
def get_classes_autosearch(folder_path: str, num_classes=None, mask_range=None) -> dict:
...
def get_classes_annotation(dataset_path):
    ...
    for i in range(len(txt)):
        color_dict[txt.loc[i, ANNOTATION_LABEL_NAME]] = [int(num) for num in txt.loc[i, ANNOTATION_COLOR_RGB].split(',')]
