...
DatasetsGroups = [
    {
        ...
        "datasets": [
            ...
            },
            {
                ...
                "inputs": {
                    1: {"1_boston_housing": {"datatype": "DIM",
                                             "dtype": "float64",
                                             "shape": (13,),
                                             "name": "Вход 1",
                                             "task": LayerInputTypeChoice.Text,
