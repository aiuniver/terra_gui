...
class FitCallback(keras.callbacks.Callback):
    ...
    def _get_metric_name_checkpoint(self, logs: dict):
        ...
        for log in logs.keys():
            if self.checkpoint_config.get('type').lower() == 'loss' and \
                    self.checkpoint_config.get('indicator').lower() == 'val' and \
            ...
            elif self.checkpoint_config.get('type').lower() == 'loss' and \
                    self.checkpoint_config.get('indicator').lower() != 'val' and \
            ...
            elif self.checkpoint_config.get('type').lower() == 'metrics' and \
                    self.checkpoint_config.get('indicator').lower() == 'val' and \
                    'val' in log:
