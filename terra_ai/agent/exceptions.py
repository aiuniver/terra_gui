...
class ExceptionMessages(dict, Enum):
    ...
    CallMethodNotFound = {
        "ru": "Экземпляр класса `%s` не имеет метод `%s`",
        "eng": "Instance of `%s` must have method `%s`",
    }
    MethodNotCallable = {
        "ru": "Метод `%s` у экземпляра класса `%s` должен быть вызываемым",
    ...
    # Project
    ProjectNotFound = {
        "ru": "Проект `%s` не найден по пути: `%s`",
        "eng": "Project `%s` not found in `%s`",
    }
    FailedGetProjectsInfo = {
        "ru": "Не удалось получить информацию о проекте. %s",
        "eng": "Error when getting projects info: %s",
    }
    FailedSaveProject = {
        "ru": "Не удалось сохранить проект. %s",
        "eng": "Error when saving project: %s",
    }
    FailedLoadProject = {
        "ru": "Не удалось загрузить проект. %s",
    ...
    FailedLoadDatasetsSource = {
        "ru": "Не удалось загрузить исходники датасета. %s",
        "eng": "Error when loading datasets source: %s",
    }
    FailedLoadProgressDatasetsSource = {
        "ru": "Не удалось получить информацию о прогрессе выбора датасета. %s",
        "eng": "Error when loading progress of datasets info: %s",
    }
    FailedGetDatasetsSources = {
        "ru": "Не удалось получить список исходников датасетов. %s",
        "eng": "Could not get the datasets sources info: %s",
    }
    FailedCreateDataset = {
        "ru": "Не удалось создать датасет. %s",
        "eng": "Could not create dataset. %s",
    }
    # Modeling
    ModelAlreadyExists = {
        "ru": "Модель `%s` уже существует",
        "eng": "Model `%s` already exists",
    }
    FailedGetModelsList = {
        "ru": "Не удалось получить список моделей. %s",
        "eng": "Could not get the models list: %s",
    }
    FailedGetModel = {
        "ru": "Не удалось получить модель. %s",
        "eng": "Error when getting the model: %s",
    }
    FailedValidateModel = {
        "ru": "Не удалось провести валидацию модели. %s",
        "eng": "Error when validating the model: %s",
    }
    FailedUpdateModel = {
        "ru": "Не удалось обновить модель. %s",
        "eng": "Error when updating the model: %s",
    }
    FailedCreateModel = {
        "ru": "Не удалось создать модель. %s",
        "eng": "Error when creating the model: %s",
    }
    FailedDeleteModel = {
        "ru": "Не получилось удалить модель. %s",
        "eng": "Error when deleting the model: %s",
    }
    # Training
    FailedStartTrain = {
        "ru": "Ошибка при старте обучения: %s",
        "eng": "Error when start training. %s",
    }
    FailedStopTrain = {
        "ru": "Ошибка при остановке обучения: %s",
        "eng": "Error when stop training model: %s",
    }
    FailedCleanTrain = {
        "ru": "Ошибка при сбросе обучения: %s",
        "eng": "Error when clean training model: %s",
    }
    FailedSetInteractiveConfig = {
        "ru": "Не удалось обновить параметры обучения. %s",
        "eng": "Error when setting interactive config: %s",
    }
    FailedGetTrainingProgress = {
        "ru": "Не удалось получить прогресс обучения. %s",
        "eng": "Could not get the progress of the training progress: %s",
    }
    FailedSaveTrain = {
        "ru": "Не удалось сохранить обучение. %s",
        "eng": "Error when save training. %s",
    }

    # Deploy
    FailedGetDeployPresets = {
        "ru": "Не удалось получить данные пресетов деплоя. %s",
        "eng": "Error when getting deploy presets data. %s",
    }
    FailedGetDeployCollection = {
        "ru": "Не удалось получить данные коллекции деплоя. %s",
        "eng": "Error when getting deploy presets data. %s",
    }
    FailedUploadDeploy = {
        "ru": "Не удалось загрузить деплой. %s",
        "eng": "Error when uploading deploy: %s",
    }
    FailedGetUploadDeployProgress = {
        "ru": "Не удалось получить прогресс загрузки деплоя. %s",
